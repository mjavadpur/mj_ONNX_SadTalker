...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, enhancer=None, background_enhancer=None, preprocess='crop', img_size=256):
        ...
        # integrate video in path with audio in new_audio_path and save to av_path
        ...
        if 'full' in preprocess.lower():
            ...
            # if image is cropped then replace cropped area in full image and 
            # integrate new generated video with audio in new_audio_path and save to full_video_path
